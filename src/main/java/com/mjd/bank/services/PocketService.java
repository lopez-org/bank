...
public interface PocketService {
   ...
   */
  SimpleMessageResponse depositFromAccount(Long ownerId, PocketDepositRequest pocketTransferRequest);
  ...
  SimpleMessageResponse depositFromPocket (Long ownerId, PocketDepositRequest withdrawRequest);
}
